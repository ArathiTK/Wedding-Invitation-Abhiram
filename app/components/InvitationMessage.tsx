...
export default function InvitationMessage() {
  ...
  return (
    <section id="invitation" className="relative isolate h-[100dvh] flex flex-col justify-center items-center overflow-hidden py-[clamp(3rem,18dvh,10rem)] px-6" style={{ scrollSnapAlign: "start", scrollSnapStop: "always" }}>
