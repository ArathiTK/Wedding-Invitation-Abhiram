...
export default function InvitationMessage() {
  return (
    <section id="invitation" className="h-[100svh] flex flex-col justify-center items-center overflow-hidden py-[clamp(3rem,18dvh,10rem)] px-6" style={{ scrollSnapAlign: "start" }}>
