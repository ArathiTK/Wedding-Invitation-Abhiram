...
export default function Footer() {
  ...
  return (
    <footer className="py-16 px-6 bg-[#3a3a3a] text-[#faf7f2]">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="font-[var(--font-cormorant)] italic text-[#c8a96e] text-xl mb-2">
          With Best Regards,
        </p>
        <p className="font-[var(--font-cormorant)] text-2xl text-[#faf7f2] mb-1">
          TK Shyam Sundar
        </p>
        <p className="font-[var(--font-cormorant)] text-2xl text-[#faf7f2] mb-8">
          &amp; Vinni Pramod
        </p>

        <div className="w-16 h-px bg-[#c8a96e] opacity-40 mx-auto mb-8" />

        {/* Contact */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
          <a
            href={`tel:${WEDDING.footer.contact}`}
        ...
        <p className="font-[var(--font-cormorant)] italic text-[#c8a96e] text-lg mb-6">
          Abhiram TK &amp; Athira K
        </p>
        <p className="text-xs tracking-widest uppercase text-[#6b6b6b]">
          06 – 07 November 2026 &middot; Kerala
        </p>

        <div className="mt-10 pt-6 border-t border-white/10">
          <p className="text-xs text-[#6b6b6b]">
            Made with love for a beautiful union
          </p>
        </div>
      </div>
    </footer>
