...
export default function ReceptionSection() {
  ...
  return (
    <section id="reception" className="min-h-[100dvh] flex flex-col justify-center py-10 px-6 bg-paper-1">
      <div className="max-w-xl mx-auto">
        <AnimateOnScroll>
          <p className="heading-display text-xs text-[#c9a876] text-center mb-2">Event Two</p>
        ...
        <AnimateOnScroll delay={0.15}>
          <div className="gold-border-card rounded-lg p-6 md:p-8" style={{ backgroundColor: "#3a322c" }}>
            <div className="flex justify-center mb-3">
              <svg width="30" height="30" viewBox="0 0 40 40" fill="none">
                <path d="M8 32 L8 16 L20 8 L32 16 L32 32" stroke="#c9a876" strokeWidth="1.5" fill="none"/>
                <rect x="15" y="22" width="10" height="10" stroke="#c9a876" strokeWidth="1.2" fill="none"/>
              </svg>
            </div>
