...
export default function CeremonySection() {
  ...
  return (
    <section id="ceremony" className="py-20 px-6 bg-[#f5efe4]">
          ...
          <div className="gold-border-card rounded-lg bg-[#faf7f2] p-8 md:p-10">
            ...
            <div className="flex justify-center mb-6">
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20 4 C12 4 6 10 6 18 C6 28 20 36 20 36 C20 36 34 28 34 18 C34 10 28 4 20 4Z" stroke="#c8a96e" strokeWidth="1.5" fill="none"/>
                <circle cx="20" cy="18" r="4" fill="#c8a96e" fillOpacity="0.6"/>
              </svg>
            </div>
            ...
            <div className="space-y-5 text-center">
              <div>
                ...
                <p className="font-[var(--font-cormorant)] text-2xl text-[#3a3a3a]">{WEDDING.ceremony.date}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-[var(--font-cormorant)] text-2xl text-[#3a3a3a]">{WEDDING.ceremony.time}</p>
              </div>
              <div className="w-16 h-px bg-[#c8a96e] opacity-40 mx-auto" />
              <div>
                <p className="text-xs tracking-widest uppercase text-[#c8a96e] mb-1">Venue</p>
                <p className="font-[var(--font-cormorant)] text-2xl text-[#3a3a3a]">{WEDDING.ceremony.venue}</p>
                <p className="text-sm text-[#6b6b6b] mt-1">{WEDDING.ceremony.address}</p>
              </div>
            </div>
